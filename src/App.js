    ...
    <div style={{ background: "", height: "100vh" }}>
      ...
      <div className="container">
        <div className="container">
          ...
          <br />{" "}
          <h3 className="col" style={{ color: "darkred" }}>
            Get Slot details using
          </h3>
          <div className="row">
            <div className="col">
              {" "}
              <button
                onClick={() => (setMethod("district"), setRegisterr(null))}
            ...
            <div className="col " style={{ marginLeft: "-40%" }}>
              <button
                onClick={() => (setMethod("pin"), setRegisterr(null))}
      ...
      {registerr ? (
        <Register registerr={registerr} eror={eror} eror2={eror2} />
      ) : null}
      {registerr ? null : method === "pin" ? <Searchbypin date={date} /> : null}
      {registerr ? null : method === "district" ? (
        <Searchbydistrict date={date} />
      ) : null}
    </div>
  );
};
